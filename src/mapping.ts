...
export function handleGotchiLendingAdd(event: GotchiLendingAdd): void {
  ...
  //
  // - contract.getGotchiLendingFromToken(...)
  // - contract.getGotchiLendingIdByToken(...)
  // - contract.getGotchiLendingListingInfo(...)
  // - contract.getGotchiLendings(...)
  // - contract.getLendingListingInfo(...)
  // - contract.getOwnerGotchiLendings(...)
  // - contract.isAavegotchiLent(...)
}
